<template>
    ...
    <div class="flex flex-col items-center h-screen p-12">
        <p class="text-24 font-bold">Registrarse</p>
...
<script setup lang="js">
    ...
    const rules = {
        ...
        repeatPassword: { sameAs: sameAs(computed(() =>user.password), "password"), maxLength: maxLength(8), required },
    }
    ...
    async function send() {
        ...
        const newUser = await usePostUser({ user: body });
